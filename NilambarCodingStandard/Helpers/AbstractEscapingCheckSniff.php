...
abstract class AbstractEscapingCheckSniff extends AbstractSniffHelper {
	...
	/**
	 * Keep track of unsanitized variables.
	 *
	 * @since 1.0.0
	 *
	...
	/**
	 * Expression severity for error reporting.
	 *
	 * @since 1.0.0
	 *
	 * @var int
	 ...
	 * @return bool Whether the variable is sanitized.
	 */
	 ...
	 *
	 * @param int      $stackPtr      The position of the current token in the stack.
	 * @param int|null $assignmentPtr The assignment pointer.
	 * @return bool Whether the variable was marked as sanitized.
	 */
	 ...
	 * @param int      $stackPtr      The position of the current token in the stack.
	 * @param int|null $assignmentPtr The assignment pointer.
	 * @return bool Whether the variable was marked as unsanitized.
	 */
	 ...
	 * @param int      $stackPtr The position of the current token in the stack.
	 * @param int|null $endPtr   The end position or null to auto-detect.
	 * @return int|false The position of the unsafe thing or false if safe.
	 */
	 ...
	 *
	 * @param int $stackPtr The position of the current token in the stack.
	 * @return string The unsafe expression as a string.
	 */
	 ...
	 *
	 * @param int $stackPtr The position of the current token in the stack.
	 * @return int|false Returns a pointer to the method call that requires escaping, if relevant.
	 */
	 ...
	 * @return bool Whether the parameter should only produce a warning.
	 */
	 ...
	 * @return bool Whether the expression should only produce a warning.
	 */
	...
	protected function is_wpdb_method_call( $stackPtr, $methods ) {
		// This is a placeholder - child classes should implement this.
		return false;
	}
	 ...
	 * @return array<string> Array of context messages.
	 */
