...
return [
    ...
    'Activation completed successfully. Some changes may not occur until you refresh the page.',
    'Plugin activated. Some changes may not occur until you refresh the page. <a %s>Refresh Now</a>',
    ...
    'Find and organize your data however you like with data views for pages, templates, patterns, and template parts. Arrange it in a table or grid view with the option to toggle fields and make bulk changes.',
    ...
    'This release includes more than 65 accessibility improvements across the platform, making it more accessible than ever. This release adds fixes to contrast settings, cursor focus, submenus, and positioning of elements, among many others, that help improve the WordPress experience for everyone.',
    'Accessibility improvements',
    'Performance updates',
    'There&#8217;s now an easier way to manage plugin dependencies. Plugin authors can supply a new %s header with a comma-separated list of required plugin slugs, presenting users with links to install and activate those plugins first.',
    ...
    'Control size, repeat, and focal point options so you can play around with subtle or splashy ways to add visual interest to layouts.',
    ...
    'Available disk space is low, less than 100 MB available.',
    ...
    'https://make.wordpress.org/core/wordpress-6-5-field-guide/',
...
###SITEURL###',
    ...
    'Plugin File Editor',
    'Theme File Editor',
    'If this is a development website you can <a href="%s" target="_blank">set the environment type accordingly</a> to enable application passwords.',
    ...
    'We take privacy and transparency very seriously',
    'The Four Freedoms',
    'themeDelete %s',
    ...
    'Plugin authors can <a href="https://developer.wordpress.org/plugins/privacy/adding-the-personal-data-exporter-to-your-plugin/" target="_blank">learn more about how to add the Personal Data Exporter to a plugin here</a>.',
    ...
    'If you are a plugin author, you can <a href="https://developer.wordpress.org/plugins/privacy/adding-the-personal-data-eraser-to-your-plugin/" target="_blank">learn more about how to add support for the Personal Data Eraser to a plugin here</a>.',
    ...
    'https://wordpress.org/documentation/article/update-services/',
...
\'Cancel\' to stop, \'OK\' to delete.',
    ...
    'Cancel and go back',
    'themeReplace active with uploaded',
    ...
    '<strong>Format</strong> &mdash; Post Formats designate how your theme will display a specific post. For example, you could have a <em>standard</em> blog post with a title and paragraphs, or a short <em>aside</em> that omits the title and contains a short text blurb. Your theme could enable all or some of 10 possible formats. <a href="https://wordpress.org/documentation/article/post-formats/#supported-formats">Learn more about each post format</a>.',
    ...
    '<a href="https://wordpress.org/documentation/article/nginx/">Documentation on Nginx configuration</a>.',
    ...
    '<a href="https://wordpress.org/documentation/article/plugins-editor-screen/">Documentation on Editing Plugins</a>',
    '<a href="https://developer.wordpress.org/themes/basics/template-tags/">Documentation on Template Tags</a>',
    '<a href="https://wordpress.org/documentation/article/editing-files/">Documentation on Editing Files</a>',
    ...
    '<a href="https://wordpress.org/documentation/article/network-admin-sites-screen/">Documentation on Site Management</a>',
...
Any changes to the directives between these markers will be overwritten.',
    ...
    'WordPress&#8217; utf8mb4 support requires MySQL client library (%1$s) version %2$s or newer. Please contact your server administrator.',
    'WordPress&#8217; utf8mb4 support requires MariaDB version %s or greater. Please contact your server administrator.',
    'WordPress&#8217; utf8mb4 support requires MySQL version %s or greater. Please contact your server administrator.',
    ...
    'utf8mb4 requires a MariaDB update',
    'Your MySQL version supports utf8mb4.',
    'utf8mb4 requires a MySQL update',
    ...
    'There are no pages.',
    'Need help putting together your new Privacy Policy page? <a href="%1$s" %2$s>Check out our privacy policy guide%3$s</a> for recommendations on what content to include, along with policies suggested by your plugins and theme.',
...
Commenter avatars come from <a href="%s">Gravatar</a>.',
    ...
    'Default is %s',
    'The language pack is missing either the %1$s or %2$s files.',
    ...
    'The active theme does not support uploading a custom header image.',
...
Click \'Cancel\' to go back, \'OK\' to confirm the delete.',
    ...
    'themeInstalled!',
    'This theme is already installed and is up to date',
    'pluginInstalled',
